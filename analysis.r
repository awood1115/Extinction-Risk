...
# SVL
plot(NAfrogs$SVL, NAfrogs$threat, xlab = "Mean SVL(mm)", ylab = "Threat Status", main = "Anura Threat Status vs. Mean SVL", col = "darkgreen", pch = 16)
lm_svl_na = lm(NAfrogs$threat ~ NAfrogs$SVL)
abline(lm_svl_na, col = "darkgreen")
summary(lm_svl_na)
points(Efrogs$SVL_Unspecified_mm, Efrogs$threat, xlab = "Mean SVL (mm)", ylab = "Threat Status", col = "mediumpurple3", pch = 16)
...
# Clutch Size
plot(NAfrogs$ClutchSize, NAfrogs$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", main = "Anura Threat Status vs. Mean Clutch Size", col = "darkgreen", pch = 16)
lm_cs_na = lm(NAfrogs$threat ~ NAfrogs$ClutchSize)
abline(lm_cs_na, col = "darkgreen")
summary(lm_cs_na)
points(Efrogs$Number_of_eggs_or_offspring, Efrogs$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", col = "mediumpurple3", pch = 16)
...
legend(19000,6, c("North American", "European"), pch = 16, 
       col = c("darkgreen", "mediumpurple3"), cex = 0.9, bty = "n")
# Habitat Breadth
plot(NAfrogs$HabitatBreadth, NAfrogs$threat, xlab = "Habitat Breadth", ylab = "Threat Status", main = "Anura Threat Status vs. Habitat Breadth", col = "darkgreen", pch = 16)
lm_hb_na = lm(NAfrogs$threat ~ NAfrogs$HabitatBreadth)
abline(lm_hb_na, col = "darkgreen")
summary(lm_hb_na)
points(Efrogs$HabitatBreadth, Efrogs$threat, xlab = "Habitat Breadth", ylab = "Threat Status", col = "mediumpurple3", pch = 16)
...
legend(6,6, c("North American", "European"), pch = 16, 
       col = c("darkgreen", "mediumpurple3"), cex = 0.9, bty = "n")
# Minimum Elevation
plot(NAfrogs$MinElevation_m, NAfrogs$threat, xlab = "Minimum Elevation (m)", ylab = "Threat Status", main = "Anura Threat Status vs. Minimum Elevation", col = "darkgreen", pch = 16)
lm_me_na = lm(NAfrogs$threat ~ NAfrogs$MinElevation_m)
abline(lm_me_na, col = "darkgreen")
summary(lm_me_na)
points(Efrogs$Altitude_min, Efrogs$threat, xlab = "Minimum Altitude (m)", ylab = "Threat Status", col = "mediumpurple3", pch = 16)
...
Multi_lm_na = lm(NAfrogs$threat ~ NAfrogs$SVL + NAfrogs$ClutchSize + NAfrogs$HabitatBreadth + NAfrogs$MinElevation_m)
summary(Multi_lm_na)
# Multi-Variable Linear Model European Frogs
Multi_lm_e = lm(Efrogs$threat ~ Efrogs$SVL_Unspecified_mm + Efrogs$Number_of_eggs_or_offspring + Efrogs$HabitatBreadth + Efrogs$Altitude_min)
summary(Multi_lm_e)

## European Anura and Urodela Comparison

# SVL
plot(Efrogs$SVL_Unspecified_mm, Efrogs$threat, xlab = "Mean SVL (mm)", ylab = "Threat Status", col = "mediumpurple3", main = "European Amphibian Threat Status vs. Mean SVL", pch = 16)
...
# Clutch Size
plot(Efrogs$Number_of_eggs_or_offspring, Efrogs$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", col = "mediumpurple3", main = "European Amphibian Threat Status vs. Clutch Size", pch = 16)
lm_cs_f = lm(Efrogs$threat ~ Efrogs$Number_of_eggs_or_offspring)
abline(lm_cs_f, col = "mediumpurple3")
summary(lm_cs_f)
points(Esalamanders$Number_of_eggs_or_offspring, Esalamanders$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", col = "palevioletred4", pch = 16)
...
legend(17000,4, c("North American", "European"), pch = 16, 
       col = c("mediumpurple3", "palevioletred4"), cex = 0.9, bty = "n")
# Habitat Breadth
plot(Efrogs$HabitatBreadth, Efrogs$threat, xlab = "Habitat Breadth", ylab = "Threat Status", col = "mediumpurple3", main = "European Amphibian Threat Status vs. Habitat Breadth", pch = 16)
lm_hb_f = lm(Efrogs$threat ~ Efrogs$HabitatBreadth)
abline(lm_hb_f, col = "mediumpurple3")
summary(lm_hb_f)
points(Esalamanders$HabitatBreadth, Esalamanders$threat, xlab = "Habitat Breadth", ylab = "Threat Status", col = "palevioletred4", pch = 16)
...
legend(3,5, c("North American", "European"), pch = 16, 
       col = c("mediumpurple3", "palevioletred4"), cex = 0.9, bty = "n")
# Minimum Elevation
plot(Efrogs$Altitude_min, Efrogs$threat, xlab = "Minimum Altitude (m)", ylab = "Threat Status", col = "mediumpurple3", main = "European Amphibian Threat Status vs. Minimum Elevation", pch = 16)
lm_me_f = lm(Efrogs$threat ~ Efrogs$Altitude_min)
abline(lm_me_f, col = "mediumpurple3")
summary(lm_me_f)
points(Esalamanders$Altitude_min, Esalamanders$threat, xlab = "Minimum Altitude (m)", ylab = "Threat Status", col = "palevioletred4", pch = 16)
...
summary(Multi_lm_e)
# Multi-Variable Linear Model European Frogs
Multi_lm_s = lm(Esalamanders$threat ~ Esalamanders$SVL_Unspecified_mm + Esalamanders$Number_of_eggs_or_offspring + Esalamanders$HabitatBreadth + Esalamanders$Altitude_min)
summary(Multi_lm_s)
...
# SVL
plot(Rana$SVL, Rana$threat, xlab = "Mean SVL(mm)", ylab = "Threat Status", main = "North American Anura Threat Status vs. Mean SVL", col = "skyblue3", pch = 16)
lm_svl_r = lm(Rana$threat ~ Rana$SVL)
abline(lm_svl_r, col = "skyblue3")
summary(lm_svl_r)
points(Anaxyrus$SVL, Anaxyrus$threat, xlab = "Mean SVL(mm)", ylab = "Threat Status", col = "purple", pch = 16)
...
# Clutch Size
plot(Rana$ClutchSize, Rana$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", main = "North American Anura Threat Status vs. Mean Clutch Size", col = "skyblue3", pch = 16)
lm_cs_r = lm(Rana$threat ~ Rana$ClutchSize)
abline(lm_cs_r, col = "skyblue3")
summary(lm_cs_r)
points(Anaxyrus$ClutchSize, Anaxyrus$threat, xlab = "Mean Clutch Size", ylab = "Threat Status", col = "purple", pch = 16)
...
legend(8000,5.5, c("Rana", "Anaxyrus"), pch = 16, 
       col = c("skyblue3", "purple"), cex = 0.9, bty = "n")
# Habitat Breadth
plot(Rana$HabitatBreadth, Rana$threat, xlab = "Habitat Breadth", ylab = "Threat Status", main = "North American Anura Threat Status vs. Habitat Breadth", col = "skyblue3", pch = 16)
lm_hb_r = lm(Rana$threat ~ Rana$HabitatBreadth)
abline(lm_hb_r, col = "skyblue3")
summary(lm_hb_r)
points(Anaxyrus$HabitatBreadth, Anaxyrus$threat, xlab = "Habitat Breadth", ylab = "Threat Status", col = "purple", pch = 16)
...
legend(5.5,5.5, c("Rana", "Anaxyrus"), pch = 16, 
       col = c("skyblue3", "purple"), cex = 0.9, bty = "n")
# Minimum Elevation
plot(Rana$MinElevation_m, Rana$threat, xlab = "Minimum Elevation (m)", ylab = "Threat Status", main = "North American Anura Threat Status vs. Minimum Elevation", col = "skyblue3", pch = 16)
lm_me_r = lm(Rana$threat ~ Rana$MinElevation_m)
abline(lm_me_r, col = "skyblue3")
summary(lm_me_r)
points(Anaxyrus$MinElevation_m, Anaxyrus$threat, xlab = "Minimum Elevation (m)", ylab = "Threat Status", col = "purple", pch = 16)
...
Multi_lm_r = lm(Rana$threat ~ Rana$SVL + Rana$ClutchSize + Rana$HabitatBreadth + Rana$MinElevation_m)
summary(Multi_lm_r)
# Multi-Variable Linear Model North American Anaxyrus
Multi_lm_a = lm(Anaxyrus$threat ~ Anaxyrus$SVL + Anaxyrus$ClutchSize + Anaxyrus$HabitatBreadth + Anaxyrus$MinElevation_m)
summary(Multi_lm_a)
